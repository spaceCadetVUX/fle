...
@section('content')
    ...
    <section class="shop-hero position-relative overflow-hidden">
        <img src="fashion/fas (21).jpg" alt="Shop Hero Background" class="shop-hero-bg w-100 h-100 position-absolute top-0 start-0 object-fit-cover" style="z-index: 0; filter: brightness(0.6);">
